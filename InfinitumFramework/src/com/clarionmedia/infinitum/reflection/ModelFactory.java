...
/**
 * <p>
 * This interface provides methods for creating new instances of model classes
 * using reflection. Also provides methods for creating new, populated instances
 * from a SQLite {@link Cursor}. It's important to note that model classes must
 * contain an empty, parameterless constructor in order for these methods to
 * work. If no such constructor is present, a
